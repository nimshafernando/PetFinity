...
return [
    ...
    */
    'routes' => [
        ...
        'namespace' => env('CHATIFY_ROUTES_NAMESPACE', 'App\Http\Controllers\Chatify'), // Update to custom namespace
    ],
    'api_routes' => [
        'prefix' => env('CHATIFY_API_ROUTES_PREFIX', 'chatify/api'),
        'middleware' => env('CHATIFY_API_ROUTES_MIDDLEWARE', ['api']),
        'namespace' => env('CHATIFY_API_ROUTES_NAMESPACE', 'App\Http\Controllers\Chatify\Api'), // Update to custom namespace
    ],
    ...
    */
    'guards' => [
        ...
        'trainingcenter' => [
            'guard' => 'trainingcenter',
            'model' => \App\Models\PetTrainingCenter::class,
        ],
        'boardingcenter' => [
            'guard' => 'boardingcenter',
            'model' => \App\Models\PetBoardingCenter::class,
        ],
    ],
];
