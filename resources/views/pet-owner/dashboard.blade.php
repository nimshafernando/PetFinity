                ...
                <div class="mb-4 col-md-4 d-flex justify-content-center">
                    <div class="appointment-card">
                        <div class="appointment-card-body">
                            <h5 class="appointment-card-title">Booking Accepted for {{ $appointment->pet->pet_name }}</h5>
                        ...
                        <p><strong>Special Notes:</strong> {{ $appointment->special_notes }}</p>
                            ...
                            <form action="{{ route('appointment.select-payment-method', $appointment->id) }}" method="POST">
                                ...
                                <button type="submit" class="mt-3 btn btn-primary">Confirm Payment Method</button>
                            </form>
                        </div>
                    </div>
                </div>
